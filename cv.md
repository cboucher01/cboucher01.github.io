...
HTML, CSS, JavaScript, GitHub, WordPress, Bootstrap, Web Content Accessibility Guidelines (WCAG), Video production and editing, Adobe Creative Suite, User experience (UX), International Image Interoperability Framework (IIIF), Oral history
